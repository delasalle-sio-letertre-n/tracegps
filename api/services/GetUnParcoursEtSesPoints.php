...
if ($lang == "xml") {
    ...
    $donnees = creerFluxXML($msg, $lesPoints);
}
else {
    $content_type = "application/json; charset=utf-8";      // indique le format Json pour la réponse
    $donnees = creerFluxJSON($msg, $lesPoints);
}
...
function creerFluxXML($msg, $lesPoints)
{	
    /* Exemple de code XML
...
function creerFluxJSON($msg, $lesPoints)
{
